...
Ação que permite acionar ações do github action via GUI no github:
```
name: Build
...
on:
  push:
    branches: [ "main" ]
  workflow_dispatch: # Permite rodar manualmente o workflow via GUI do Github
```


Executar o docker compose em partes
```
